...
def main():
    ...
    ap.add_argument("-d", "--distribute", required=False, default='distributed',
    ...
    if args['distribute']:
        d3 = D3(Input=reader)
        SaveData(args['distribute'], proxy=d3, PointDataArrays=['___D3___GlobalNodeIds', 'p', 'u', 'v', 'vtkGhostType', 'w'],
