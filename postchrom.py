...
@usage: ./postchrom.py <fsim> <msim> <b|n|s> > post.out
        <fsim> & <msim> are simulation subfolders for flow and mass simulations
        <b|n|s>: binding, nonbinding and solid beads
        Run script in simulation's ROOT directory. Looks for files in ROOT, ROOT/FLOW/<fsim>, ROOT/MASS/<msim>
        Ensure that mesh log file contains necessary keywords & info.
